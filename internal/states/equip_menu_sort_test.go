...
func TestEquipMenuWearSortIntegration(t *testing.T) {
	...
	// クリーンアップ
	world.ECS.RemoveEntity(wearable1)
	world.ECS.RemoveEntity(wearable2)
	world.ECS.RemoveEntity(wearable3)
}
...
func TestEquipMenuWeaponSortIntegration(t *testing.T) {
	...
	// クリーンアップ
	world.ECS.RemoveEntity(weapon1)
	world.ECS.RemoveEntity(weapon2)
	world.ECS.RemoveEntity(weapon3)
}
