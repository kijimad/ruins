...
var conditionDefs = map[ConditionType]ConditionDef{
	ConditionHypothermia: {
		...
		// 常在圧力なので反応率は外傷より軽くする
		painPerSeverity: 6, bodyFuncDropPerSeverity: 10,
	...
	ConditionFracture: {
		...
		painPerSeverity: 18, bodyFuncDropPerSeverity: 20,
	...
	ConditionLaceration: {
		...
		painPerSeverity: 8, bodyFuncDropPerSeverity: 8,
	...
	ConditionLiverIllness: {
		...
		painPerSeverity: 4, bodyFuncDropPerSeverity: 10,
