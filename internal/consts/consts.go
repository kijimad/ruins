...
const (
	...
	// FuelGaugeFullHeat は運転HUDの燃料ゲージが満タン表示になる熱量。実在の上限ではなく表示上の
	// タンク容量で、これに対する比でゲージを描く。DriveFuelCost と対比すると空キューブで約600タイル、
	// 満載500kgで約6タイルぶんにあたる。値は暫定で実プレイで手応えを見て調整する
