...
var (
	errWindowWidthTooSmall  = errors.New("window width is too small")
...
func (c *Config) Validate() error {
	if c.User.WindowWidth < 320 {
		return fmt.Errorf("%w: %d, minimum 320", errWindowWidthTooSmall, c.User.WindowWidth)
	}
	...
	if c.PProfPort < 1024 || c.PProfPort > 65535 {
		return fmt.Errorf("%w: %d, range 1024 to 65535", errPProfPortOutOfRange, c.PProfPort)
	}
	return nil
}
