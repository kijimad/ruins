...
func TestRenderStatusSectionGolden(t *testing.T) {
	...
	docs := []*Document{
		{Path: "docs/design/20260628_42.md", Title: "隊員アイテム運搬システム",
			Front: Frontmatter{Status: StatusInProgress, Tags: []string{"member"}}, HasProgress: true, DoneTasks: 0, OpenTasks: 11},
		{Path: "docs/design/20260710_51.md", Title: "ECSエンジンの Ark 移行",
		...
		{Path: "docs/design/20260122_1.md", Title: "完了した設計",
			Front: Frontmatter{Status: StatusDone}, HasProgress: true, DoneTasks: 6},
		{Path: "docs/design/20260609_27.md", Title: "不採用の設計",
...
func TestRenderStatusSectionGolden_AllDone(t *testing.T) {
	...
	docs := []*Document{
		{Path: "docs/design/20260122_1.md", Title: "設計A", Front: Frontmatter{Status: StatusDone}, HasProgress: true, DoneTasks: 3},
		{Path: "docs/design/20260123_2.md", Title: "設計B", Front: Frontmatter{Status: StatusDone}, HasProgress: true, DoneTasks: 5},
	}
