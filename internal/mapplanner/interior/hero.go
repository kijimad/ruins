...
// von Restorff 効果により異質な項目は孤立しているほど記憶されるので、landmark 級は狭い確率で1棟に1つに絞る
// (doc L695-697)。中身は Cogmind の性格配分 報酬46/雰囲気25/リスクリワード15/危険14 を予算表の初期値にして、
// 主室の中央へ1つだけ据える。docs/design/20260725_70.md 追記その5 収穫5・追記その16。
