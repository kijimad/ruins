...
// 敷地の類型。1チャンク=1建物なので、街区の短冊分割でなく建物ごとに敷地の性格を1つ引く。CDDA は parcel
// 分割をせず塀・門・前庭ごとテンプレに焼き込む(doc L676-679)。ここでは前庭の深さ・塀・外構の出し分けで、
// 戸建・商店街・ロードサイドの見えの違いを作る。旗竿地・団地は多チャンクの配棟が要るので今後。
// docs/design/20260725_70.md 追記その4 収穫1・追記その15。
