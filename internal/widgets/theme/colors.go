...
var (
	...
	// アイコン自体も半透明にして、グリフの下の地形も透かす
	OverworldMapCubeMarker = color.RGBA{R: 90, G: 180, B: 255, A: 190}
	// OverworldMapCubeOutline はキューブアイコンの縁取り色。地形を塗りつぶさず、アイコンだけに
	// 暗い縁を付けてどの地形色の上でも読めるようにする。本体と同じく半透明にする
	OverworldMapCubeOutline = color.RGBA{R: 10, G: 12, B: 16, A: 150}
