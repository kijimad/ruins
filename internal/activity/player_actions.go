		...
		for _, interaction := range interactable.Interactions {
			...
			case gc.InteractionAuction:
				gamelog.New(query.GetGameLog(world)).
					...
					Log()
			case gc.InteractionDoor, gc.InteractionTalk, gc.InteractionItemAll, gc.InteractionStorage, gc.InteractionMelee, gc.InteractionDisassemble, gc.InteractionExitCube, gc.InteractionPullCube, gc.InteractionCubePanel, gc.InteractionIgnite:
