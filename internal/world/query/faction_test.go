...
func TestFactionRelation(t *testing.T) {
	...
	t.Run("味方と敵は敵対", func(t *testing.T) {
		...
		world.Components.FactionAlly.Add(ally, &gc.FactionAllyData{})
	...
	t.Run("味方同士は友好", func(t *testing.T) {
		t.Parallel()
		world := testutil.InitTestWorld(t)
		ally1 := world.World.NewEntity()
		world.Components.FactionAlly.Add(ally1, &gc.FactionAllyData{})
		ally2 := world.World.NewEntity()
		world.Components.FactionAlly.Add(ally2, &gc.FactionAllyData{})
	...
	t.Run("敵同士は友好", func(t *testing.T) {
		...
		world.Components.FactionEnemy.Add(enemy1, &gc.FactionEnemyData{})
		enemy2 := world.World.NewEntity()
		world.Components.FactionEnemy.Add(enemy2, &gc.FactionEnemyData{})
	...
	t.Run("中立と敵は中立", func(t *testing.T) {
		t.Parallel()
		world := testutil.InitTestWorld(t)
		neutral := world.World.NewEntity()
		world.Components.FactionNeutral.Add(neutral, &gc.FactionNeutralData{})
		enemy := world.World.NewEntity()
		world.Components.FactionEnemy.Add(enemy, &gc.FactionEnemyData{})
