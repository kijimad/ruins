...
func TestFactionRelation(t *testing.T) {
	...
	t.Run("味方と敵は敵対", func(t *testing.T) {
		...
		world.Components.Faction.Add(ally, &gc.Faction{Kind: gc.FactionAlly})
	...
	t.Run("味方同士は友好", func(t *testing.T) {
		...
		world.Components.Faction.Add(ally1, &gc.Faction{Kind: gc.FactionAlly})
		ally2 := world.ECS.NewEntity()
		world.Components.Faction.Add(ally2, &gc.Faction{Kind: gc.FactionAlly})
	...
	t.Run("敵同士は友好", func(t *testing.T) {
		...
		world.Components.Faction.Add(enemy1, &gc.Faction{Kind: gc.FactionEnemy})
		enemy2 := world.ECS.NewEntity()
		world.Components.Faction.Add(enemy2, &gc.Faction{Kind: gc.FactionEnemy})
	...
	t.Run("中立と敵は中立", func(t *testing.T) {
		...
		world.Components.Faction.Add(neutral, &gc.Faction{Kind: gc.FactionNeutral})
		enemy := world.ECS.NewEntity()
		world.Components.Faction.Add(enemy, &gc.Faction{Kind: gc.FactionEnemy})
