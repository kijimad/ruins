...
func BuyPrice(world w.World, player ecs.Entity, entity ecs.Entity) consts.Currency {
	...
	return consts.Currency(ProficiencyValue(world, player, gc.ProfBuyPrice).ApplyInt(int(price)))
}
...
func SellPrice(world w.World, player ecs.Entity, entity ecs.Entity) consts.Currency {
	...
	return consts.Currency(ProficiencyValue(world, player, gc.ProfSellPrice).ApplyInt(int(price)))
}
