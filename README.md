...
| draft | [大きなゲームループ: 一方向逃避を駆動と終端で閉じる](docs/design/260821223229.md) | 1/10 | gamedesign, narrative, worldgen |
| draft | [身体モデル: 血を生命ゲージに、部位の傷でドラマを作り、病気に免疫レースを足す](docs/design/260821232324.md) | 0/15 | gamedesign, combat, item, ecs |
