...
| [84](docs/design/20260802_84.md) | draft | メニューをタブ化して手数を減らす —— 動詞タブ・画面タブ・1カラム統一 | 8/11（見送り1） | ui, item |
